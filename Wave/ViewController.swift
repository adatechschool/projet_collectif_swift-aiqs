...
//  Wave
//
//  Created by Quentin LEE on 09/05/2022.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        carouselData.append(.init(image: UIImage(named: "la-torche"), text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit"))
        carouselData.append(.init(image: UIImage(named: "surfer-img"), text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit"))
        carouselData.append(.init(image: UIImage(named: "wave"), text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit"))
